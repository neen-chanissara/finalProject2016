...
';
				...
				draw: {
					...
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1800, gl.UNSIGNED_SHORT, 710340);
					},
					c: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3628884);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3628872);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 47880, gl.UNSIGNED_SHORT, 567780);
					},
					d: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 370764);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 370752);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 65535, gl.UNSIGNED_SHORT, 68580);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1943604);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1943592);
						gl.drawElements(gl.TRIANGLES, 155949, gl.UNSIGNED_SHORT, 199650);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3516396);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3516384);
						gl.drawElements(gl.TRIANGLES, 28116, gl.UNSIGNED_SHORT, 511548);
					},
					e: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 32760, gl.UNSIGNED_SHORT, 720);
					},
					...
					g: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4700160);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 7200, gl.UNSIGNED_SHORT, 713940);
					},
					h: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 17124);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 17112);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1170, gl.UNSIGNED_SHORT, 66240);
					},
					i: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 4402284);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4402272);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 23400, gl.UNSIGNED_SHORT, 663540);
					}
				},
