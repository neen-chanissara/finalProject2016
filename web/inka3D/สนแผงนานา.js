...
{\n\
	...
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0901961, 0.0940108, 0.0856336)) * vec3(0.341252, 0.478629, 0.175707) + vec3(pow(max(h.x + h.y + h.z, 0.0), 98.0784) * 0.5) + vec3(0.073579, 0.341878, 0.103044);\n\
