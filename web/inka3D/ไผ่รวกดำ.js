...
{\n\
	...
	float j = i * 0.25;\n\
	vec3 k = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + 0.350423) * vec3(0.0921708, 0.158, 0.038078) + vec3(j / (1.0 - i + j)) * 0.5 * vec3(0.822785, 0.0416599, 0.137993);\n\
...
';
					...
					global.scaleOffset5 = new Float32Array([0.00113469, 0.00641646, 0.00103319, 0.0, -1.80163, 71.4658, 12.7914, 0.0]);
					...
					global.scaleOffset2 = new Float32Array([0.00135967, 0.00970564, 3.85954e-4, 0.0, -81.8494, 71.5023, -13.2532, 0.0]);
					global.scaleOffset1 = new Float32Array([0.0010162, 0.00974036, 6.6351e-4, 0.0, 6.8469, 93.4314, -13.9023, 0.0]);
				...
				draw: {
					...
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 155484, gl.UNSIGNED_SHORT, 68544);
					},
					...
					d: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1268556);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1268544);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
					...
					e: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1405788);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1405776);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
					...
					f: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1543020);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1543008);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
