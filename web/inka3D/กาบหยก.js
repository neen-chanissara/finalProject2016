...
{\n\
	...
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.1333, 0.2666, 0.1333)) * vec3(0.556962, 0.105752, 0.129338) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.1333, 0.2666, 0.1333);\n\
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0, 0.2509, 0.0)) * vec3(0.987342, 0.024996, 0.188202) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.0, 0.2509, 0.0);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0, 0.349, 0.0)) * vec3(0.746835, 0.103989, 0.213011) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.0, 0.349, 0.0);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.1294, 0.2627, 0.1294)) * vec3(0.911392, 0.207659, 0.327006) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.1294, 0.2627, 0.1294);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0, 0.3176, 0.0)) * vec3(0.911392, 0.184585, 0.307846) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.0, 0.3176, 0.0);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.196, 0.3921, 0.196)) * vec3(0.898734, 0.12514, 0.256335) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.196, 0.3921, 0.196);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 457092);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 457080);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 720, gl.UNSIGNED_SHORT, 43188);
					},
					b: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 391860);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 391848);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 2520, gl.UNSIGNED_SHORT, 36468);
					},
					c: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 354252);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 354240);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 2520, gl.UNSIGNED_SHORT, 31428);
					},
					d: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 99852);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 99840);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 10800, gl.UNSIGNED_SHORT, 9828);
					},
					e: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 442500);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 442488);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 840, gl.UNSIGNED_SHORT, 41508);
					},
					f: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 69804);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 69792);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1470, gl.UNSIGNED_SHORT, 6888);
					},
					...
					h: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1764, gl.UNSIGNED_SHORT, 3360);
					}
				},
