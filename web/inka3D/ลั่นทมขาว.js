...
{\n\
	...
	float j = i * 0.25;\n\
	vec3 k = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + 0.451) * vec3(0.683544, 0.641822, 0.49319) + vec3(j / (1.0 - i + j)) * 0.5 * 0.35;\n\
...
';
					...
					global.scaleOffset3 = new Float32Array([0.0143429, 0.018698, 0.019774, 0.0, -479.759, 320.114, -661.188, 0.0]);
					global.scaleOffset2 = new Float32Array([0.0148497, 0.0212743, 0.021175, 0.0, -469.931, 86.1747, -693.852, 0.0]);
					global.scaleOffset1 = new Float32Array([0.015092, 0.0195448, 0.0207271, 0.0, -503.248, 283.08, -688.164, 0.0]);
					global.scaleOffset0 = new Float32Array([0.0122138, 0.0226508, 0.0178544, 0.0, -408.444, 0.0113254, -588.029, 0.0]);
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.drawElements(gl.TRIANGLES, 38880, gl.UNSIGNED_SHORT, 0);
					},
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 107436, gl.UNSIGNED_SHORT, 77760);
					},
					c: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 752628);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 752616);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 17820, gl.UNSIGNED_SHORT, 292632);
					},
					d: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 880644);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 880632);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 23634, gl.UNSIGNED_SHORT, 328272);
					}
				},
