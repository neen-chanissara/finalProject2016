var โพธิบัลลังก์ = function(engine)
{
	'use strict';
	var s = {
		textures:
...
{\n\
	...
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.1333, 0.2666, 0.1333)) * vec3(0.293187, 0.157667, 0.518987) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.1333, 0.2666, 0.1333);\n\
...
';
					...
					// mesh, shader 'plants13:violet_1Pdncle1'
					var vsm_plants13_cviolet__1Pdncle1 =
'precision highp float;\n\
uniform vec4 _b[4];\n\
uniform vec4 _c[7];\n\
attribute vec3 _1;\n\
...
';
					var psm_plants13_cviolet__1Pdncle1 =
'precision highp float;\n\
uniform float f_f;\n\
varying vec3 _d;\n\
varying vec3 _e;\n\
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0, 0.349, 0.0)) * vec3(0.407777, 0.242268, 0.683544) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.0, 0.349, 0.0);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0, 0.349, 0.0)) * vec3(0.274987, 0.105752, 0.556962) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.0, 0.349, 0.0);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.196, 0.3921, 0.196)) * vec3(0.386148, 0.207659, 0.683544) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.196, 0.3921, 0.196);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0, 0.3176, 0.0)) * vec3(0.407777, 0.242268, 0.683544) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.0, 0.3176, 0.0);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.1294, 0.2627, 0.1294)) * vec3(0.481192, 0.374939, 0.658228) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.1294, 0.2627, 0.1294);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0, 0.2509, 0.0)) * vec3(0.407777, 0.242268, 0.683544) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.0, 0.2509, 0.0);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
					...
					{
						var shader = shaders.m_plants13_cviolet__1Pdncle1;
						var vertexShader = engine.createVertexShader(vsm_plants13_cviolet__1Pdncle1, "mesh, shader 'plants13:violet_1Pdncle1'");
						var pixelShader = engine.createPixelShader(psm_plants13_cviolet__1Pdncle1, "mesh, shader 'plants13:violet_1Pdncle1'");
						var program = shader.program = gl.createProgram();
						gl.attachShader(program, vertexShader);
						gl.attachShader(program, pixelShader);
						gl.bindAttribLocation(program, 1, '_1');
				...
				render: {
					...
					m_plants13_cviolet__1Pdncle1_5: function(renderJob)
					{
						var instance = renderJob.instance;
						var global = instance.global;
						var shader = global.shaders.m_plants13_cviolet__1Pdncle1;
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 14604);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 14592);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1680, gl.UNSIGNED_SHORT, 1680);
					},
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 840, gl.UNSIGNED_SHORT, 0);
					},
					c: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 97812);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 97800);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1470, gl.UNSIGNED_SHORT, 11520);
					},
					d: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 178500);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 178488);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1764, gl.UNSIGNED_SHORT, 19500);
					},
					e: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 127860);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 127848);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 2520, gl.UNSIGNED_SHORT, 14460);
					},
					f: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 42924);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 42912);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 2520, gl.UNSIGNED_SHORT, 5040);
					},
					g: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 219972);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 219960);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 10800, gl.UNSIGNED_SHORT, 23028);
					},
					h: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 80532);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 80520);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 720, gl.UNSIGNED_SHORT, 10080);
					}
				},
