...
';
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 135924);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 135912);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1170, gl.UNSIGNED_SHORT, 122544);
					},
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 32760, gl.UNSIGNED_SHORT, 18720);
					},
					...
					e: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 470796);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 470784);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 19152, gl.UNSIGNED_SHORT, 84240);
					},
					f: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 949212);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 949200);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 47880, gl.UNSIGNED_SHORT, 124884);
					},
					g: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 23400, gl.UNSIGNED_SHORT, 719844);
					},
