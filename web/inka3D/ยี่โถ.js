...
';
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1336860);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1336848);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 7200, gl.UNSIGNED_SHORT, 157284);
					},
					b: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 495180);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 495168);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 19152, gl.UNSIGNED_SHORT, 49140);
					},
					...
					d: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1423260);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1423248);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 65535, gl.UNSIGNED_SHORT, 171684);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 2996100);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 2996088);
						gl.drawElements(gl.TRIANGLES, 155949, gl.UNSIGNED_SHORT, 302754);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 4568892);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4568880);
						gl.drawElements(gl.TRIANGLES, 28116, gl.UNSIGNED_SHORT, 614652);
					},
					e: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 954828);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 954816);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1800, gl.UNSIGNED_SHORT, 87444);
					},
					f: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 21132);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 21120);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 23400, gl.UNSIGNED_SHORT, 2340);
					},
					g: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1328220);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1328208);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 360, gl.UNSIGNED_SHORT, 156564);
					},
					h: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 32760, gl.UNSIGNED_SHORT, 91044);
					},
					i: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 4681380);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4681368);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 47880, gl.UNSIGNED_SHORT, 670884);
					}
				},
