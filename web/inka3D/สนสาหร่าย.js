...
{\n\
	...
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0441443, 0.205127, 0.0618143)) * vec3(0.276447, 0.384618, 0.146089) + vec3(pow(max(h.x + h.y + h.z, 0.0), 98.0784) * 0.5) + vec3(0.136263, 0.286549, 0.358968);\n\
