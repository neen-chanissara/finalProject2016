...
{\n\
	...
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0275596, 0.0506329, 0.0279303)) * vec3(0.371809, 0.443038, 0.196282) + vec3(pow(max(h.x + h.y + h.z, 0.0), 34.0) * 0.35) + vec3(0.196282, 0.443038, 0.244126);\n\
