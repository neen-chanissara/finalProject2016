...
{\n\
	...
	vec3 d = vec3(max(c.x + c.y + c.z, 0.0) * 0.803419) * vec3(0.9834, 0.986113, 0.958985) + vec3(0.172456, 0.525582, 0.260738);\n\
...
';
					...
					global.scaleOffset10 = new Float32Array([4.35684e-5, 1.97128e-5, 3.97186e-5, 0.0, -2.68657, 9.31011, -1.06968, 0.0]);
					global.scaleOffset9 = new Float32Array([9.897e-5, 4.71527e-5, 1.22189e-4, 0.0, -3.06945, 4.29322, -8.34094, 0.0]);
					global.scaleOffset8 = new Float32Array([9.897e-5, 3.5382e-5, 1.29933e-4, 0.0, -3.05585, 4.25961, -0.172335, 0.0]);
					global.scaleOffset7 = new Float32Array([1.28613e-4, 4.11148e-5, 1.02928e-4, 0.0, 0.276364, 2.54692, -3.73904, 0.0]);
					global.scaleOffset6 = new Float32Array([1.35131e-4, 3.6798e-5, 1.02928e-4, 0.0, -8.70593, 2.51431, -3.73904, 0.0]);
					global.scaleOffset5 = new Float32Array([3.00293e-6, 3.00369e-5, 3.00293e-6, 0.0, 0.0795015, 1.50184e-5, -0.431298, 0.0]);
					global.scaleOffset12 = new Float32Array([3.00293e-6, 3.00369e-5, 3.00293e-6, 0.0, 0.0795015, 1.96851, -0.431298, 0.0]);
					global.scaleOffset14 = new Float32Array([3.00293e-6, 3.00369e-5, 3.00445e-6, 0.0, 0.0795015, 5.84931, -0.174398, 0.0]);
					global.scaleOffset11 = new Float32Array([3.00293e-6, 3.01712e-5, 6.89849e-6, 0.0, 0.0795015, 3.90451, -0.430496, 0.0]);
					global.scaleOffset13 = new Float32Array([3.00293e-6, 3.01712e-5, 6.89849e-6, 0.0, 0.0795015, 7.78531, -0.173496, 0.0]);
					global.scaleOffset4 = new Float32Array([8.91266e-5, 3.22189e-5, 7.91748e-5, 0.0, -5.75705, 6.28351, -2.70366, 0.0]);
					global.scaleOffset3 = new Float32Array([8.91266e-5, 3.22189e-5, 7.91763e-5, 0.0, 0.271944, 6.28151, -2.68816, 0.0]);
					global.scaleOffset2 = new Float32Array([4.39148e-5, 1.88186e-5, 3.95874e-5, 0.0, 0.190822, 9.30621, -1.11138, 0.0]);
					global.scaleOffset1 = new Float32Array([6.96747e-5, 2.51968e-5, 8.53287e-5, 0.0, -2.10156, 7.91421, 0.00314266, 0.0]);
					global.scaleOffset0 = new Float32Array([6.96747e-5, 3.26049e-5, 8.34167e-5, 0.0, -2.08786, 7.93941, -5.53005, 0.0]);
				...
				draw: {
					...
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1236);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1224);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 276);
					},
					c: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 2460);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 2448);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 552);
					},
					d: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3684);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3672);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 828);
					},
					e: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 4908);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4896);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 1104);
					},
					f: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 6132);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 6120);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 1380);
					},
					g: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 6516);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 6504);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 1452);
					},
					h: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 7740);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 7728);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 1728);
					},
					i: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 8964);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 8952);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 2004);
					},
					j: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 10188);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 10176);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 2280);
					},
					k: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 11388);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 11376);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 2556);
					},
					l: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 12612);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 12600);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 2832);
					},
					m: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 12996);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 12984);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 2904);
					},
					n: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 13380);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 13368);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 2976);
					},
