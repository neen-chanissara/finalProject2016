...
';
					...
					global.scaleOffset5 = new Float32Array([0.0171299, 0.0369616, 0.0166698, 0.0, -732.589, 1718.85, -6.38136, 0.0]);
					global.scaleOffset4 = new Float32Array([0.0271372, 0.0119375, 0.0188249, 0.0, 339.377, 1615.94, -1213.82, 0.0]);
					global.scaleOffset3 = new Float32Array([0.0164303, 0.0379612, 0.0290029, 0.0, 325.925, 1739.77, 9.7037, 0.0]);
					global.scaleOffset2 = new Float32Array([0.0200861, 0.0527543, 0.0467736, 0.0, -246.496, 0.0263771, -1727.89, 0.0]);
					global.scaleOffset1 = new Float32Array([0.0125152, 0.0446959, 0.0133426, 0.0, -340.98, 1701.7, -810.718, 0.0]);
					global.scaleOffset0 = new Float32Array([0.0192951, 0.0126443, 0.0298075, 0.0, 317.696, 1709.2, -1910.41, 0.0]);
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.drawElements(gl.TRIANGLES, 6315, gl.UNSIGNED_SHORT, 0);
					},
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 27180);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 27168);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 2763, gl.UNSIGNED_SHORT, 12630);
					},
					c: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 40932);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 40920);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 19578, gl.UNSIGNED_SHORT, 18156);
					},
					d: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 129348);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 129336);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 11241, gl.UNSIGNED_SHORT, 57312);
					},
					e: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 180540);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 180528);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 6798, gl.UNSIGNED_SHORT, 79794);
					},
					f: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 209244);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 209232);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 9057, gl.UNSIGNED_SHORT, 93390);
					}
				},
