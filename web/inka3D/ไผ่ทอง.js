...
{\n\
	...
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + 0.451) * vec3(0.389555, 0.392405, 0.109277) + pow(max(h.x + h.y + h.z, 0.0), 20.0) * vec3(0.241016, 1.0, 0.344564);\n\
...
';
					...
					global.scaleOffset6 = new Float32Array([5.22896e-4, 0.00836552, 5.39351e-4, 0.0, 9.70106, 71.487, -19.7195, 0.0]);
					global.scaleOffset5 = new Float32Array([0.0010162, 0.00974036, 6.6351e-4, 0.0, 6.8469, 93.4314, -13.9023, 0.0]);
					global.scaleOffset4 = new Float32Array([0.00483078, 0.0079436, 0.0053849, 0.0, -162.778, 216.117, -189.043, 0.0]);
					global.scaleOffset3 = new Float32Array([5.70767e-4, 0.00789312, 0.00214104, 0.0, -10.6878, 93.4123, 2.54977, 0.0]);
					global.scaleOffset2 = new Float32Array([0.00113469, 0.00641646, 0.00103319, 0.0, -1.80163, 71.4658, 12.7914, 0.0]);
				...
				draw: {
					...
					e: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 88920, gl.UNSIGNED_SHORT, 274176);
					},
					f: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 155484, gl.UNSIGNED_SHORT, 452016);
					},
					g: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 2027484);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 2027472);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
