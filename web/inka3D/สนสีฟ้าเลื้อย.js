var สนสีฟ้าเลื้อย = function(engine)
{
	'use strict';
	var s = {
		textures:
...
{\n\
	...
	vec3 d = vec3(max(c.x + c.y + c.z, 0.0) * 0.8) * vec3(0.266784, 0.402145, 0.468354) + vec3(0.130144, 0.213672, 0.121721);\n\
...
';
				...
				draw: {
					...
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 2403, gl.UNSIGNED_SHORT, 7518);
					},
