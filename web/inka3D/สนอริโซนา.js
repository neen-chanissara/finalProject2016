...
{\n\
	...
	vec3 d = vec3(max(c.x + c.y + c.z, 0.0) * 0.8) * vec3(0.279251, 0.506329, 0.256369) + vec3(0.130144, 0.213672, 0.121721);\n\
...
';
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.drawElements(gl.TRIANGLES, 2403, gl.UNSIGNED_SHORT, 0);
					},
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 22260);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 22248);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 786, gl.UNSIGNED_SHORT, 4806);
					},
					c: function(instance, shader)
					{
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset0);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 33420);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 33408);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 3759, gl.UNSIGNED_SHORT, 6378);
					}
				},
