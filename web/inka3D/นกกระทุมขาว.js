var นกกระทุมขาว = function(engine)
{
	'use strict';
	var s = {
		textures:
...
{\n\
	...
	vec3 d = vec3(max(c.x + c.y + c.z, 0.0) * 0.8) * vec3(0.830573, 0.989035, 0.883394) + vec3(0.0824292, 0.264957, 0.0157778);\n\
...
';
					...
					global.scaleOffset14 = new Float32Array([8.91266e-5, 3.22189e-5, 7.91748e-5, 0.0, -5.75705, 6.28351, -2.70366, 0.0]);
					global.scaleOffset13 = new Float32Array([6.96747e-5, 3.26049e-5, 8.34167e-5, 0.0, -2.08786, 7.93941, -5.53005, 0.0]);
					global.scaleOffset12 = new Float32Array([6.96747e-5, 2.51968e-5, 8.53287e-5, 0.0, -2.10156, 7.91421, 0.00314266, 0.0]);
					global.scaleOffset11 = new Float32Array([3.00293e-6, 3.00369e-5, 3.00293e-6, 0.0, 0.0795015, 1.50184e-5, -0.431298, 0.0]);
					global.scaleOffset10 = new Float32Array([4.39148e-5, 1.88186e-5, 3.95874e-5, 0.0, 0.190822, 9.30621, -1.11138, 0.0]);
					global.scaleOffset9 = new Float32Array([9.897e-5, 3.5382e-5, 1.29933e-4, 0.0, -3.05585, 4.25961, -0.172335, 0.0]);
					global.scaleOffset8 = new Float32Array([9.897e-5, 4.71527e-5, 1.22189e-4, 0.0, -3.06945, 4.29322, -8.34094, 0.0]);
					...
					global.scaleOffset5 = new Float32Array([1.28613e-4, 4.11148e-5, 1.02928e-4, 0.0, 0.276364, 2.54692, -3.73904, 0.0]);
					global.scaleOffset4 = new Float32Array([8.91266e-5, 3.22189e-5, 7.91763e-5, 0.0, 0.271944, 6.28151, -2.68816, 0.0]);
					global.scaleOffset0 = new Float32Array([3.00293e-6, 3.00369e-5, 3.00293e-6, 0.0, 0.0795015, 1.96851, -0.431298, 0.0]);
					global.scaleOffset2 = new Float32Array([3.00293e-6, 3.01712e-5, 6.89849e-6, 0.0, 0.0795015, 3.90451, -0.430496, 0.0]);
					global.scaleOffset1 = new Float32Array([3.00293e-6, 3.00369e-5, 3.00445e-6, 0.0, 0.0795015, 5.84931, -0.174398, 0.0]);
					global.scaleOffset3 = new Float32Array([3.00293e-6, 3.01712e-5, 6.89849e-6, 0.0, 0.0795015, 7.78531, -0.173496, 0.0]);
				...
				draw: {
					...
					c: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 780);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 768);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
					...
					d: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1164);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1152);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
					...
					e: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1548);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1536);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 288);
					},
					f: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 2772);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 2760);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 564);
					},
					g: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3996);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3984);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 840);
					},
					h: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 5220);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 5208);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 1116);
					},
					i: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 6444);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 6432);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 1392);
					},
					j: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 7644);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 7632);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 1668);
					},
					k: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 8868);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 8856);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 1944);
					},
					l: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 10092);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 10080);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 2220);
					},
