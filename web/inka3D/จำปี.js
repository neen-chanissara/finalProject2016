...
{\n\
	...
	vec3 i = texture2D(_c, (_e * vec2(1.0, 8.0) + vec2(-1.0, 0.0)) * vec2(1.0, -1.0) + vec2(0.0, 1.0)).xyz * vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + pow(max(h.x + h.y + h.z, 0.0), 2.0) * vec3(0.234577, 0.772152, 0.373768) + vec3(0.195161, 0.367088, 0.24411);\n\
