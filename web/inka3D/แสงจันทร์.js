...
{\n\
	...
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0275596, 0.0506329, 0.0279303)) * vec3(0.886076, 0.876522, 0.20189) + vec3(pow(max(h.x + h.y + h.z, 0.0), 34.0) * 0.35) + vec3(0.090959, 0.256412, 0.0933547);\n\
