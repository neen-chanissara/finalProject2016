var กวักเงินใหญ่ = function(engine)
{
	'use strict';
	var s = {
		textures:
...
{\n\
	...
	vec3 d = (vec3(max(c.x + c.y + c.z, 0.0) * 0.8) + vec3(0.145296, 0.14348, 0.143999)) * vec3(0.0262778, 0.518987, 0.153852) + vec3(0.220462, 0.222217, 0.221622);\n\
...
';
					...
					global.scaleOffset14 = new Float32Array([4.39148e-5, 1.88186e-5, 3.95874e-5, 0.0, 0.190822, 9.30621, -1.11138, 0.0]);
					global.scaleOffset13 = new Float32Array([4.35684e-5, 1.97128e-5, 3.97186e-5, 0.0, -2.68657, 9.31011, -1.06968, 0.0]);
					global.scaleOffset12 = new Float32Array([9.897e-5, 4.71527e-5, 1.22189e-4, 0.0, -3.06945, 4.29322, -8.34094, 0.0]);
					global.scaleOffset11 = new Float32Array([9.897e-5, 3.5382e-5, 1.29933e-4, 0.0, -3.05585, 4.25961, -0.172335, 0.0]);
					global.scaleOffset10 = new Float32Array([1.28613e-4, 4.11148e-5, 1.02928e-4, 0.0, 0.276364, 2.54692, -3.73904, 0.0]);
					global.scaleOffset5 = new Float32Array([8.91266e-5, 3.22189e-5, 7.91763e-5, 0.0, 0.271944, 6.28151, -2.68816, 0.0]);
					global.scaleOffset4 = new Float32Array([1.35131e-4, 3.6798e-5, 1.02928e-4, 0.0, -8.70593, 2.51431, -3.73904, 0.0]);
					global.scaleOffset3 = new Float32Array([3.00293e-6, 3.00369e-5, 3.00293e-6, 0.0, 0.0795015, 1.50184e-5, -0.431298, 0.0]);
					global.scaleOffset9 = new Float32Array([3.00293e-6, 3.00369e-5, 3.00293e-6, 0.0, 0.0795015, 1.96851, -0.431298, 0.0]);
					global.scaleOffset8 = new Float32Array([3.00293e-6, 3.00369e-5, 3.00445e-6, 0.0, 0.0795015, 5.84931, -0.174398, 0.0]);
					global.scaleOffset6 = new Float32Array([3.00293e-6, 3.01712e-5, 6.89849e-6, 0.0, 0.0795015, 3.90451, -0.430496, 0.0]);
					global.scaleOffset7 = new Float32Array([3.00293e-6, 3.01712e-5, 6.89849e-6, 0.0, 0.0795015, 7.78531, -0.173496, 0.0]);
					global.scaleOffset2 = new Float32Array([6.96747e-5, 2.51968e-5, 8.53287e-5, 0.0, -2.10156, 7.91421, 0.00314266, 0.0]);
					global.scaleOffset1 = new Float32Array([8.91266e-5, 3.22189e-5, 7.91748e-5, 0.0, -5.75705, 6.28351, -2.70366, 0.0]);
				...
				draw: {
					...
					d: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 828);
					},
					e: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 4068);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4056);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 900);
					},
					f: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 5292);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 5280);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 1176);
					},
					g: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 1452);
					},
					h: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 6900);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 6888);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 1524);
					},
					i: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 7284);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 7272);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 1596);
					},
					j: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 7668);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 7656);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 1668);
					},
					k: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 1740);
					},
					l: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 9276);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 9264);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 2016);
					},
					m: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 10500);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 10488);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 2292);
					},
					n: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 11700);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 11688);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 2568);
					},
					o: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 12924);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 12912);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 138, gl.UNSIGNED_SHORT, 2844);
					}
				},
