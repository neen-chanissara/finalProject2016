...
{\n\
	...
	vec3 i = texture2D(_c, (_e * vec2(1.0, 8.0) + vec2(-1.0, 0.0)) * vec2(1.0, -1.0) + vec2(0.0, 1.0)).xyz * vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + pow(max(h.x + h.y + h.z, 0.0), 2.0) * vec3(0.544304, 0.0641935, 0.0413395) + vec3(0.0413395, 0.544304, 0.170985);\n\
...
';
				...
				draw: {
					...
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 16905, gl.UNSIGNED_SHORT, 12);
					},
