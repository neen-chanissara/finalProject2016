...
{\n\
	...
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0275596, 0.0506329, 0.0279303)) * vec3(0.746835, 0.71393, 0.264701) + vec3(pow(max(h.x + h.y + h.z, 0.0), 34.0) * 0.35) + vec3(0.607662, 0.746835, 0.264701);\n\
