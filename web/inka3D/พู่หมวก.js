	...
	var s = {
		...
		scenes:
		{
			"พู่หมวก":
			{
				...
				{
					// mesh, shader 'plants3:Newplan_1InfInt1'
					var vsm_plants3_cNewplan__1InfInt1 =
...
';
					var psm_plants3_cNewplan__1InfInt1 =
'precision highp float;\n\
uniform float f_f;\n\
varying vec3 _d;\n\
varying vec3 _e;\n\
...
';
					...
					{
						var shader = shaders.m_plants3_cNewplan__1InfInt1;
						var vertexShader = engine.createVertexShader(vsm_plants3_cNewplan__1InfInt1, "mesh, shader 'plants3:Newplan_1InfInt1'");
						var pixelShader = engine.createPixelShader(psm_plants3_cNewplan__1InfInt1, "mesh, shader 'plants3:Newplan_1InfInt1'");
				...
				render: {
					m_plants3_cNewplan__1InfInt1_5: function(renderJob)
					{
						...
						var shader = global.shaders.m_plants3_cNewplan__1InfInt1;
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 86412);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 86400);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 360, gl.UNSIGNED_SHORT, 14400);
					},
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1170, gl.UNSIGNED_SHORT, 764304);
					},
					c: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 40071, gl.UNSIGNED_SHORT, 265104);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3139596);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3139584);
						gl.drawElements(gl.TRIANGLES, 71424, gl.UNSIGNED_SHORT, 345246);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 4712412);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4712400);
						gl.drawElements(gl.TRIANGLES, 138105, gl.UNSIGNED_SHORT, 488094);
					},
					d: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 900852);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 900840);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 19152, gl.UNSIGNED_SHORT, 114480);
					},
					e: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1360500);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1360488);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 32760, gl.UNSIGNED_SHORT, 152784);
					},
					f: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 7200, gl.UNSIGNED_SHORT, 0);
					},
					g: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 95052);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 95040);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1800, gl.UNSIGNED_SHORT, 15120);
					},
					h: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 127452);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 127440);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 47880, gl.UNSIGNED_SHORT, 18720);
					},
					i: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1566720);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 23400, gl.UNSIGNED_SHORT, 218304);
					}
				},
