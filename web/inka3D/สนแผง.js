...
{\n\
	...
	vec3 d = vec3(max(c.x + c.y + c.z, 0.0) * 0.8) * vec3(0.170453, 0.64557, 0.122576);\n\
...
';
				...
				draw: {
					...
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 3759, gl.UNSIGNED_SHORT, 4806);
					},
					c: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 786, gl.UNSIGNED_SHORT, 12324);
					}
				},
