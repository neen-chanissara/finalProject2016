...
';
				...
				draw: {
					...
					b: function(instance, shader)
					{
						...
						gl.drawElements(gl.TRIANGLES, 83235, gl.UNSIGNED_SHORT, 146910);
					},
					c: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 2793, gl.UNSIGNED_SHORT, 329700);
						...
						gl.drawElements(gl.TRIANGLES, 44424, gl.UNSIGNED_SHORT, 466356);
					},
					d: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1566720);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 8160, gl.UNSIGNED_SHORT, 313380);
					}
				},
