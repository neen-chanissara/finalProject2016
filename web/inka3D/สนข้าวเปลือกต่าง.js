var สนข้าวเปลือกต่าง = function(engine)
{
	'use strict';
	var s = {
		textures:
...
{\n\
	...
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.0901961, 0.0940108, 0.0856336)) * vec3(0.414023, 0.418799, 0.408194) + vec3(pow(max(h.x + h.y + h.z, 0.0), 98.0784) * 0.5) + vec3(0.163764, 0.227848, 0.0865246);\n\
