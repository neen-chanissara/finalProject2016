	...
	var s = {
		...
		scenes:
		{
			"เทียนกิ่ง":
			{
				...
				{
					// mesh, shader 'plants3:Newplan_1Pdncle1'
					var vsm_plants3_cNewplan__1Pdncle1 =
...
';
					var psm_plants3_cNewplan__1Pdncle1 =
'precision highp float;\n\
uniform float f_f;\n\
varying vec3 _d;\n\
varying vec3 _e;\n\
...
';
					...
					var b1 = d.decompress8(681846);
					var b2 = d.decompress16(681846);
					var vb = new Float32Array(1363692);
					for (var i = 0, j = 0; i < 227282; ++i, j += 6)
					{
						vb[j + 0] = b2[i + 0];
						vb[j + 1] = b2[i + 227282];
						vb[j + 2] = b2[i + 454564];
						vb[j + 3] = (b1[i + 0] << 24) * 4.65661e-10;
						vb[j + 4] = (b1[i + 227282] << 24) * 4.65661e-10;
						vb[j + 5] = (b1[i + 454564] << 24) * 4.65661e-10;
					}
					...
					{
						var shader = shaders.m_plants3_cNewplan__1Pdncle1;
						var vertexShader = engine.createVertexShader(vsm_plants3_cNewplan__1Pdncle1, "mesh, shader 'plants3:Newplan_1Pdncle1'");
						var pixelShader = engine.createPixelShader(psm_plants3_cNewplan__1Pdncle1, "mesh, shader 'plants3:Newplan_1Pdncle1'");
				...
				render: {
					m_plants3_cNewplan__1Pdncle1_5: function(renderJob)
					{
						...
						var shader = global.shaders.m_plants3_cNewplan__1Pdncle1;
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.drawElements(gl.TRIANGLES, 7200, gl.UNSIGNED_SHORT, 704724);
					},
					b: function(instance, shader)
					{
						...
						gl.drawElements(gl.TRIANGLES, 155949, gl.UNSIGNED_SHORT, 131070);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3145644);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3145632);
						gl.drawElements(gl.TRIANGLES, 28116, gl.UNSIGNED_SHORT, 442968);
					},
					c: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3258132);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3258120);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1800, gl.UNSIGNED_SHORT, 499200);
					},
					d: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3750180);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3750168);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1170, gl.UNSIGNED_SHORT, 541104);
					},
					e: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3750852);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3750840);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 32760, gl.UNSIGNED_SHORT, 639204);
					},
					f: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4700160);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 23400, gl.UNSIGNED_SHORT, 719124);
					},
					g: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3290532);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3290520);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 19152, gl.UNSIGNED_SHORT, 502800);
					},
					h: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3771300);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3771288);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 47880, gl.UNSIGNED_SHORT, 543444);
					},
					i: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4700160);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 360, gl.UNSIGNED_SHORT, 765924);
					}
				},
