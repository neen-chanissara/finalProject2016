...
';
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.drawElements(gl.TRIANGLES, 1170, gl.UNSIGNED_SHORT, 720);
					},
					b: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 4404636);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4404624);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 7200, gl.UNSIGNED_SHORT, 663540);
					},
					c: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 4491036);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4491024);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 19152, gl.UNSIGNED_SHORT, 677940);
					},
					d: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3287892);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3287880);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 32760, gl.UNSIGNED_SHORT, 502260);
					},
					e: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1800, gl.UNSIGNED_SHORT, 716244);
					},
					...
					g: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 29772);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 29760);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 65535, gl.UNSIGNED_SHORT, 3060);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1602612);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1602600);
						gl.drawElements(gl.TRIANGLES, 155949, gl.UNSIGNED_SHORT, 134130);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3175404);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3175392);
						gl.drawElements(gl.TRIANGLES, 28116, gl.UNSIGNED_SHORT, 446028);
					},
					h: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 3631236);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 3631224);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
