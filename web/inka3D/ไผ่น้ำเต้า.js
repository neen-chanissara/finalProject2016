var ไผ่น้ำเต้า = function(engine)
{
	'use strict';
	var s = {
		textures:
...
{\n\
	...
	float j = i * 0.25;\n\
	vec3 k = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + 0.350423) * vec3(0.397526, 0.658228, 0.183304) + vec3(j / (1.0 - i + j)) * 0.5 * vec3(0.400642, 0.594937, 0.240987);\n\
...
';
					...
					global.scaleOffset6 = new Float32Array([0.00135967, 0.00970564, 3.85954e-4, 0.0, -81.8494, 71.5023, -13.2532, 0.0]);
					global.scaleOffset5 = new Float32Array([0.0010162, 0.00974036, 6.6351e-4, 0.0, 6.8469, 93.4314, -13.9023, 0.0]);
					global.scaleOffset4 = new Float32Array([0.00113469, 0.00641646, 0.00103319, 0.0, -1.80163, 71.4658, 12.7914, 0.0]);
					global.scaleOffset3 = new Float32Array([0.00483078, 0.0079436, 0.0053849, 0.0, -162.778, 216.117, -189.043, 0.0]);
					global.scaleOffset2 = new Float32Array([5.70767e-4, 0.00789312, 0.00214104, 0.0, -10.6878, 93.4123, 2.54977, 0.0]);
					global.scaleOffset1 = new Float32Array([5.22896e-4, 0.00836552, 5.39351e-4, 0.0, 9.70106, 71.487, -19.7195, 0.0]);
					global.scaleOffset0 = new Float32Array([8.912e-4, 0.00814759, 0.00157879, 0.0, -7.89325, 71.4876, -111.117, 0.0]);
				...
				draw: {
					...
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 34272, gl.UNSIGNED_SHORT, 68544);
					},
					c: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 274476);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 274464);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 34272, gl.UNSIGNED_SHORT, 137088);
					},
					d: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 411708);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 411696);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 88920, gl.UNSIGNED_SHORT, 205632);
					},
					e: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 896076);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 896064);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 34272, gl.UNSIGNED_SHORT, 383472);
					},
					f: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1033308);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1033296);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 34272, gl.UNSIGNED_SHORT, 452016);
					},
					g: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1170444);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1170432);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 34272, gl.UNSIGNED_SHORT, 520560);
					},
					h: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1307676);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1307664);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 155484, gl.UNSIGNED_SHORT, 589104);
					}
				},
