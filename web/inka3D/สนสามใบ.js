...
{\n\
	...
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(1.0, 1.0, 0.0)) * vec3(0.192276, 0.379746, 0.242797) + pow(max(h.x + h.y + h.z, 0.0), 2.06) * vec3(0.1176, 0.4745, 0.1176);\n\
