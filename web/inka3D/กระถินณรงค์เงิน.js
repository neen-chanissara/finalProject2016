var กระถินณรงค์เงิน = function(engine)
{
	'use strict';
	var s = {
		textures:
...
{\n\
	...
	vec3 d = texture2D(_c, (_e * vec2(1.0, 8.0) + vec2(-1.0, 0.0)) * vec2(1.0, -1.0) + vec2(0.0, 1.0)).xyz * (vec3(max(c.x + c.y + c.z, 0.0) * 0.8) + vec3(0.1755, 0.432, 0.0));\n\
