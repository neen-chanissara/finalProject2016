...
{\n\
	...
	vec3 g = c * vec3(0.408248, -0.408248, -0.816497);\n\
	vec3 h = (vec3(0.408248, -0.408248, -0.816497) - (g.x + g.y + g.z) * 2.0 * c) * -(d * inversesqrt(e.x + e.y + e.z));\n\
	vec3 i = (vec3(max(f.x + f.y + f.z, 0.0) * 0.8) + vec3(0.204867, 0.581201, 0.198733)) * vec3(0.598291, 0.149645, 0.0) + vec3(pow(max(h.x + h.y + h.z, 0.0), 34.0) * 0.35) + vec3(0.123506, 0.350423, 0.119829);\n\
	gl_FragColor = vec4(i, 1.0);\n\
}\n\
';
					...
					global.scaleOffset4 = new Float32Array([0.00372055, 5.80859e-4, 0.00372055, 0.0, -129.683, 369.25, -137.475, 0.0]);
					global.scaleOffset3 = new Float32Array([0.00945058, 0.0109956, 0.00975558, 0.0, -321.755, 300.292, -334.252, 0.0]);
					global.scaleOffset2 = new Float32Array([0.00533418, 0.0064556, 0.00533418, 0.0, -182.557, 0.0032278, -190.349, 0.0]);
					global.scaleOffset1 = new Float32Array([0.0138891, 0.0113603, 0.0141161, 0.0, -455.113, 301.952, -462.552, 0.0]);
					global.scaleOffset0 = new Float32Array([0.00372055, 5.80859e-4, 0.00372055, 0.0, -129.683, 369.25, -137.475, 0.0]);
				...
				draw: {
					a: function(instance, shader)
					{
						...
						gl.drawElements(gl.TRIANGLES, 1224, gl.UNSIGNED_SHORT, 0);
					},
					b: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 5316);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 5304);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 70344, gl.UNSIGNED_SHORT, 2448);
					},
					c: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 313044);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 313032);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 33912, gl.UNSIGNED_SHORT, 143136);
					},
					d: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 739404);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 739392);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 39504, gl.UNSIGNED_SHORT, 210960);
					},
					...
					g: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 70344, gl.UNSIGNED_SHORT, 436800);
					},
					h: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 1796436);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 1796424);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 1224, gl.UNSIGNED_SHORT, 577488);
					}
				},
