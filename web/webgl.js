...
mesh = new THREE.Mesh( geometry,new THREE.MeshPhongMaterial({color: 0xCCFFCC}));
...
mesh = new THREE.Mesh( geometry,new THREE.MeshPhongMaterial({color: 0x005500}));
...
mesh = new THREE.Mesh( geometry,new THREE.MeshPhongMaterial({color: 0x009900}));
